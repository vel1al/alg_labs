...
2. Даны 3 различных массива целых чисел (размер каждого не превышает 15). В каждом
массиве найти сумму элементов и среднеарифметическое значение.'''
...
def task2_func(arr):
    ...
    print(f"сумма: {sum}, среднеарифметическое: {round(sum/count, 2)}")
